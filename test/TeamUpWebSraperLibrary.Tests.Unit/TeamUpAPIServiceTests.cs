		...
		var expected = new EventResponse
		{
			Events = new List<Event>
			{
				new Event
				{
					...
					EndDate = new DateTimeOffset(2024, 12, 01, 16, 00, 00, new TimeSpan(-5, 0, 0)),
					CreationDate = new DateTimeOffset(2024, 11, 21, 17, 37, 31, new TimeSpan(-5, 0, 0)),
					UpdateDate = new DateTimeOffset(2024, 11, 24, 07, 32, 20, new TimeSpan(-5, 0, 0)),
